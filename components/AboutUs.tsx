...
const AboutUs = () => {
  return (
    <section id="about-us" className='relative container bg-about-us bg-no-repeat bg-cover max-sm:px-4 py-10 md:py-5'>
        <div className='flex flex-col max-sm:gap-16 sm:flex-row justify-center items-center'>
            ...
            <div className='flex flex-1 flex-col justify-center items-center z-10'>
                ...
                <NavButton href='#home' containerStyles='mt-10 special-shadow-box special-border border-2 border-solid'
